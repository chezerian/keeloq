...
offset=2**30
hexplain=numpy.vectorize(hex)

data_points = 2**4 # ~8 million data points, ~32 MB data
workers = 2**4 # 256 workers, play with this to see performance differences
...
r=0
while r<528:
				ciph = ((ciph<<1)^bit(ciph,31)^bit(ciph,15)^bit(key,(15-r)&63)^bit(KeeLoq_NLF,g5(ciph,0,8,19,25,30)))
				r=r+1
			   
plain_result=ciph&0xFFFFFFFF
